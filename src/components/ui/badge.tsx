...
export interface BadgeProps
  extends React.HTMLAttributes<HTMLDivElement> {
    variant?: keyof typeof badgeVariantConfig.variants.variant;
  }

function Badge({ className, variant, ...props }: BadgeProps) {
  const variantClass = badgeVariantConfig.variants.variant[variant || 'default'];
  return (
...
export { Badge }
export type { BadgeProps as BadgeVariants };
