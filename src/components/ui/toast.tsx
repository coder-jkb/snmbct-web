...
interface ToastProps extends React.ComponentPropsWithoutRef<typeof ToastPrimitives.Root> {
    variant?: keyof typeof toastVariantConfig.variants.variant;
}
...
>(({ className, variant = "default", ...props }, ref) => {
  const variantClass = toastVariantConfig.variants.variant[variant]
  return (
    <ToastPrimitives.Root
      ref={ref}
      className={cn(toastVariantConfig.base, variantClass, className)}
      {...props}
    />
  )
})
...
type ToastPropsWithoutVariant = Omit<React.ComponentPropsWithoutRef<typeof Toast>, "variant">
